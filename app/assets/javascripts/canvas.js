...
function imageList(data) {
  for (var i = 0; i < data.length; i++) {
    ...
    console.log(('<li>' + '<img src="' + BASE_URL + 'capstone/pix2pix-tensorflow/test-output/' + data[i] - '/home/ubuntu/capstone/pix2pix-tensorflow/test-output/' + '" alt="processed_portrait">' + '</li>'));
  }
}
